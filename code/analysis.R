...
png(paste0(ot,"sys_",ifelse(xX<1,"0",""),xX*10,".png"))
par(mfrow = c(2,1))
...
##### yield distribution #####
png(paste0(ot,"yld_",ifelse(xX<1,"0",""),xX*10,".png"))
par(mfrow=c(1,1))
...
legend("topright", inset=c(0,0), legend = c("P_only","P+B"), pch = rep(16,2), col = c(cBpT[4],cBpT[2]), bty="n", cex = 1.5)
dev.off()
}
