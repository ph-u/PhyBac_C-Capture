...
Activation energies for phytoplanktons and bacteria are 0.32eV and 0.66eV respectively\autocite{regaudie2012temperature}.  Standardised rate unit in data was initially ``sec$^{-1}$" and the unit was re-standardised to ``\dayU" for this study (Fig.\ref{f:A0}).
