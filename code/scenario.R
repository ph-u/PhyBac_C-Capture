...
rEsult = as.data.frame(matrix(NA, nc=8, nr=nrow(paRef)*500))
colnames(rEsult) = c("ePR","eP","gP","aP", "eBR","eB","gB","mB")
...
write.csv(rEsult, "../data/scenario.csv", quote = F, row.names = F)
