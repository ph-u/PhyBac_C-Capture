...
Equations were listed as the rate of density (grams of carbon per metre cube) change of state variables per day.  Three state variables of densities (C for organic carbon, P for phytoplankton and B for bacteria), two sets of four biological parameters (one set for P and another set for B) and one harvest rate parameter was included in this minimal carbon cycle model.
