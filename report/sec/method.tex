...
Analytical solve using SymPy (v1.0.7) in Julia-lang (v1.3.1)\autocite{bezanson2012julia} revealed four alternative equilibria for PBH, two of them shared with PoH.  A single yet different equilibrium was found for PBN and PoN respectively (Table \ref{tab:eqm}).
